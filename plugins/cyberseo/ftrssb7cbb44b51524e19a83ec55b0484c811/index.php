...
<html>
  ...
  <body>
	...
	<ol>
		...
		<li>Enter a feed or article URL in the form above and click 'Create Feed' <a href="https://help.fivefilters.org/full-text-rss/example-feeds.html" rel="tooltip" title="Need suggestions? We've got a number of feeds and articles you can try" class="label">?</a></li>
	...
	<h3>Configure</h3>
	<p>In addition to the options above, Full-Text RSS comes with a configuration file which allows you to control how the application works. <a href="https://help.fivefilters.org/full-text-rss/configure.html">Find out more.</a></p>
	<p>Features include:</p>
	<ul>
		<li>Site patterns for better control over extraction (<a href="https://help.fivefilters.org/full-text-rss/site-patterns.html">more info</a>)</li>
...
<p>If enabled, we'll pass retrieved HTML content through htmLawed (safe flag on and style attributes denied). Note: when enabled this will remove certain elements you may want to preserve, such as iframes.</p></td>
		...
		<tr>
			...
			<td>The default parser is HTML5-PHP as it can handle modern HTML better than libxml. HTML5-PHP is an HTML5 parser implemented in PHP. It's slower than libxml, but usually produces better results. You can request libxml be used as the parser in a site-specific config file (to ensure it gets used for all URLs for that site), or explicitly via this request parameter.</td>
		</tr>
	...
	<ul>
		...
		<li><a href="http://pear.php.net/package/Text_LanguageDetect">Text_LanguageDetect</a></li>
		<li><a href="https://github.com/mtibben/html2text">Html2Text</a></li>
	</ul>

	<h3>System Requirements</h3>
	
	<p>PHP 5.6 or above is required. A simple shared web hosting account should work fine, but we recommend a <a href="https://help.fivefilters.org/full-text-rss/hosting.html#hetzner-cloud-vps">VPS</a>.
