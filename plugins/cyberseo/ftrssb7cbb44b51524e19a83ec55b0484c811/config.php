...
//$options->allowed_parsers = array('html5php'); //disables libxml - forcing html5php in all cases

// Default parser
// --------------
// By default, Full-Text RSS will use HTML5-PHP (an HTML5
// parser, but written in PHP).
// You can also set this 'libxml' which might be a little faster but not as compatible
// with modern HTML.
...
// For example:
//$options->proxy_servers = array('example1'=>array('host'=>'127.0.0.1:8888'), 'example2'=>array('host'=>'127.0.0.1:8888', 'auth'=>'user:pass'), 'direct'=>'direct');
...
$options->fingerprints = array(
	...
	'<meta data-rh="true" property="al:ios:app_name" content="Medium"/>' => array('hostname'=>'fingerprint.medium.com', 'head'=>true),
	// Substack
	'<link rel="stylesheet" type="text/css" href="https://substackcdn.com/min/main.css' => array('hostname'=>'fingerprint.substack.com', 'head'=>false)
);
...
if (!defined('_FF_FTR_VERSION')) define('_FF_FTR_VERSION', '3.9.12');
