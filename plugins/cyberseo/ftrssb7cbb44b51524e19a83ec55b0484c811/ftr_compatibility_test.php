...
https://help.fivefilters.org/full-text-rss/hosting.html
...
<div id="site">
	<div id="content">
		...
		<div class="chunk">
			...
			<?php echo '<p class="highlight">HTML5-PHP will be used for parsing.</p>'; ?>
			-->
