...
(function(c, u) {
	...
	const c = {
			...
			youtube: {
				...
				html: '<iframe style="width:100%;" height="450" frameborder="0" allowfullscreen></iframe>',
				height: 450,
				width: '100%',
				id: ([n, i]) => {
					if (!i && n) return n;
			...
			instagram: {
				...
				html: '<iframe width="400" height="690" style="margin: 0 auto;" frameborder="0" scrolling="no" allowtransparency="true"></iframe>',
				height: 690,
				width: 400,
				id: n => {
					var i;
