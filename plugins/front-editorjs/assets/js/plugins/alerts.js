 ...
 * Original file: /npm/editorjs-alerts@1.2.1/dist/bundle.js
 *
	...
	var e = {
				...
				e.exports = function(e) {
					...
					return t.toString = function() {
						...
						for (var s = 0; s < e.length; s++) {
							var d = [].concat(e[s]);
							n && i[d[0]] || (void 0 !== a && (void 0 === d[5] || (d[1] = "@layer".concat(d[5].length > 0 ? " ".concat(d[5]) : "", " {").concat(d[1], "}")), d[5] = a), r && (d[2] ? (d[1] = "@media ".concat(d[2], " {").concat(d[1], "}"), d[2] = r) : d[2] = r), o && (d[4] ? (d[1] = "@supports (".concat(d[4], ") {").concat(d[1], "}"), d[4] = o) : d[4] = "".concat(o)), t.push(d))
						}
					}, t
				}
			},
			...
			620: (e, t, r) => {
				...
				var n = r(379),
					...
					m = r(800),
					h = {};
				h.styleTagTransform = g(), h.setAttributes = d(), h.insert = l().bind(null, "head"), h.domAPI = i(), h.insertStyleElement = u(), o()(m.Z, h), m.Z && m.Z.locals && m.Z.locals
			},
			379: e => {
				"use strict";
				var t = [];
	...
	return (() => {
		...
		var _ = function() {
			function e(t) {
				...
				}(this, e), this.api = o, this.defaultType = n.defaultType || e.DEFAULT_TYPE, this.defaultAlign = n.defaultAlign || e.DEFAULT_ALIGN_TYPE, this.messagePlaceholder = n.messagePlaceholder || e.DEFAULT_MESSAGE_PLACEHOLDER, this.titlePlaceholder = n.titlePlaceholder || e.DEFAULT_TITLE_PLACEHOLDER, this.data = {
			...
			return r = e, n = [{
				...
				key: "render",
				value: function() {
					var e = [this.CSS.wrapper, this.CSS.wrapperForType(this.data.type), this.CSS.wrapperForAlignType(this.data.align)];
					this.container = this._make("div", e);
					var t = this._make("div", [this.CSS.message], {
						contentEditable: !this.readOnly,
						innerHTML: this.data.message
					});
					t.dataset.placeholder = this.messagePlaceholder;
					var r = this._make("div", [this.CSS.title], {
						contentEditable: !this.readOnly,
						innerHTML: this.data.title
					});
					return r.dataset.placeholder = this.titlePlaceholder, this.container.appendChild(r), this.container.appendChild(t), this.container
				}
			}, {
				key: "renderSettings",
				value: function() {
					var t = this,
						r = e.ALERT_TYPES.map((function(e) {
							return {
								icon: a(),
								name: "alert-".concat(e),
						...
						n = e.ALIGN_TYPES.map((function(e) {
							return {
								icon: "left" == e ? c() : "center" == e ? s() : "right" == e ? p() : IconAlign_left,
								name: "align-".concat(e),
								label: t._getFormattedName(e),
								toggle: "align",
				...
				value: function(e) {
					var t = e.querySelector(".".concat(this.CSS.message)),
						r = e.querySelector(".".concat(this.CSS.title));
				...
				value: function(e) {
					...
					for (var a in Array.isArray(r) ? (t = o.classList).add.apply(t, h(r)) : r && o.classList.add(r), n) o[a] = n[a];
					return o
				}
			}, {
				key: "onPaste",
