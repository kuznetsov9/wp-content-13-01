...
function dark_mode_dashboard_add_styles() {
    ...
    */
if ( get_user_meta( get_current_user_id(), 'dark_mode_dashboard', true ) != 1 ) {
...
function dark_mode_dashboard_save_user_profile_fields( $user_id ) {
    ...
    // Если чекбокс не нажат, в $_POST его не будет. 
    // Присваиваем 0, если ключа нет, и 1, если есть.
    $dark_mode_value = isset( $_POST['dark_mode_dashboard'] ) ? 1 : 0;
    update_user_meta( $user_id, 'dark_mode_dashboard', $dark_mode_value );
}
