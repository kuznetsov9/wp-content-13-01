...
<div class="profile-cover">
 ...
 <div class="profile-header d-flex align-items-start justify-content-between">
   ...
   <div class="profile-btn-subscribe d-flex align-items-center gap-2">
     <?php if ( get_current_user_id() != $author_id ) : ?>
                             
							 <?php echo do_shortcode('[subscription_button user_id="' . $author_id . '"]'); ?>
							 
							 <?php if (is_plugin_active('bp-better-messages/bp-better-messages.php')) { ?>
							  <a href="<?php echo do_shortcode('[better_messages_pm_button user_id="' . $author_id . '" target="_self" fast_start="1" url_only="1"]'); ?>" class="profile-btn-message" title="<?php echo esc_attr__( 'Написать сообщение', 'esenin' ); ?> ">
