...
class ESN_Customizer_Helper {
	...
	public static function get_value( $field_id = '' ) {
		...
		if ( isset( ESN_Customizer::$fields[ $field_id ] ) && isset( ESN_Customizer::$fields[ $field_id ]['default'] ) ) {
			$default_value = ESN_Customizer::$fields[ $field_id ]['default'];
		}

		$value = get_theme_mod( $field_id, $default_value );

		/**
		 * The esn_customizer_values_get_value hook.
		 *
		 * @since 1.0.0
		 */
		return apply_filters( 'esn_customizer_values_get_value', $value, $field_id );
	}
